...
import { getTableColumns, gristApiRequest } from './GenericFunctions';
	...
	description: INodeTypeDescription = {
		...
		properties: [
			authentication,
			{
				...
				default: '',
				required: true,
				description: 'The ID of the Grist document, found in its URL or in Document Settings',
			},
			{
				...
				default: '',
				required: true,
				description: 'The ID of the table to watch',
			},
			{
	...
	webhookMethods = {
		default: {
			async checkExists(this: IHookFunctions): Promise<boolean> {
				...
				const docId = this.getNodeParameter('docId') as string;
